...
public class InputDataClass extends JFrame {
    ...
    JTextField rilisField = new JTextField(4);
    ...
    public class SaveButtonListener implements ActionListener {
        ...
        public void actionPerformed(ActionEvent ae) {
            try {
                ...
                statement.executeUpdate("INSERT INTO film (judul,sinopsis,tgl_rilis,harga) values ('" + judulField.getText() + "','" + sinopsisArea.getText() + "','" + rilisField.getText() +"','" + hargaField.getText() +"')");
                
                JOptionPane.showMessageDialog(null, "Film Didaftarkan!", "Hasil", JOptionPane.INFORMATION_MESSAGE);
                statement.close();
                koneksi.close();
                Kosong();
    ...
    public class DeleteButtonListener implements ActionListener {
        ...
        public void actionPerformed(ActionEvent ae) {
            try {
                ...
                koneksi = DriverManager.getConnection(DBurl, DBusername, DBpassword);
                statement = koneksi.createStatement();
                statement.executeUpdate("DELETE FROM film WHERE Judul='" + judulField.getText() + "'");
