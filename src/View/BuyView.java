...
public class BuyView extends JFrame {
    ...
    JLabel total = new JLabel("Rp. " + 0.0);
    ...
    public BuyView(String TheJudul, String TheJam) {
        ...
        add(judul).setBounds(600, 30, 800, 50);
        judul.setFont(new Font("Calibri", judul.getFont().getStyle(), 20));
        
        add(jam).setBounds(610, 70, 100, 50);
        jam.setFont(new Font(jam.getFont().getName(), jam.getFont().getStyle(), 14));
        
        add(theSeat).setBounds(660, 145, 100, 50);
        theSeat.setFont(new Font(theSeat.getFont().getName(), theSeat.getFont().getStyle(), 15));
        add(jumlah).setBounds(750, 145, 100, 50);
        jumlah.setFont(new Font(jumlah.getFont().getName(), jumlah.getFont().getStyle(), 15));
        
        add(theTot).setBounds(660, 185, 100, 50);
        theTot.setFont(new Font(theTot.getFont().getName(), theTot.getFont().getStyle(), 15));
        add(total).setBounds(740, 185, 150, 50);
        total.setFont(new Font(total.getFont().getName(), total.getFont().getStyle(), 15));
