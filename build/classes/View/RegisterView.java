...
public class RegisterView extends JFrame {
    ...
    public RegisterView() {
        ...
        add(userLbl).setBounds(80, 55, 70, 10);
        add(passLbl).setBounds(80, 105, 70, 10);
        add(emailLbl).setBounds(80, 155, 70, 10);
        add(alamatLbl).setBounds(80, 205, 70, 10);
        ...
        add(backBtn).setBounds(120, 270, 80, 25);
        add(confirmBtn).setBounds(250, 270, 80, 25);
    }
